...
public class FIListaUsuarios extends javax.swing.JInternalFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        FIUsuario.id = Integer.parseInt(dtm.getValueAt(indice,0).toString());
    ...
    private void btnmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodificarActionPerformed
        try {
            modif = true;
            FIUsuario.id = Integer.parseInt(dtm.getValueAt(jTable1.getSelectedRow(), 0).toString());
            FIUsuario.nombre = dtm.getValueAt(jTable1.getSelectedRow(), 2).toString();
            FIUsuario.contrasenia = dtm.getValueAt(jTable1.getSelectedRow(), 3).toString();
            FIUsuario.dni = dtm.getValueAt(jTable1.getSelectedRow(), 3).toString();
